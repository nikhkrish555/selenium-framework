...
public class LoginPage {
	...
	@FindBy(className="primary") WebElement loginButton;
	@FindBy(xpath="//*[@class='header content']//div[@class='customer-menu']//li[@class='authorization-link']") WebElement signOut;
	...
	public void signOutApplication() throws InterruptedException {
		...
		List<WebElement> element = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(customerMenu));
